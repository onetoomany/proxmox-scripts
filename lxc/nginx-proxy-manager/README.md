# Fork from ej52 to fix bugs with Proxmox 7.2
...
```bash
curl -sL https://raw.githubusercontent.com/onetoomany/proxmox/main/lxc/nginx-proxy-manager/create.sh | bash -s
```
...
```bash
curl -sL https://raw.githubusercontent.com/onetoomany/proxmox/main/lxc/nginx-proxy-manager/create.sh | bash -s -- --cores 4
```
...
```bash
wget --no-cache -qO - https://raw.githubusercontent.com/onetoomany/proxmox/main/lxc/nginx-proxy-manager/setup.sh | sh
```
